...
- **图标：** 35个金色线描+小红印功能/节日SVG + 6个TabBar SVG
- **TabBar：** 暗色毛玻璃 + 金色选中态
- **海报：** 750×1334 Canvas节日主题模板，按节日自动切换视觉主题
...
- [x] 历史记录页：倒序列表 + 空状态
- [x] 我的页：节日提醒 + 关于 + 反馈
- [x] 8个组件：3个picker + blessing-card + poster-canvas + empty/loading-state + tab-bar
...
### 阶段 2.6：海报修复
- [x] 组件查找：preview.wxml添加id="posterCanvas"
- [x] 分享按钮：改为open-type="share"
- [x] Canvas缩放修复：标准dpr缩放
- [x] 海报视觉重写：对齐星云夜幕品牌（深色渐变+金色光斑+星光+玻璃卡片）
- [x] 文案截断修复：6行→12行，150字以上自动缩小字号
- **状态：** complete

### 阶段 2.7：UI图标体系 & 节日海报模板
- [x] 图标方向确定：中式金色线描 + 小红印点缀
- [x] 新增35个SVG图标，覆盖节日/对象/风格/操作/菜单/空状态
- [x] 选择器与页面主功能emoji替换为本地图标
- [x] 海报从单一星云模板升级为多节日主题模板
- [x] Canvas坐标系统一为750×1334海报逻辑尺寸
...
| UI风格 | 星云夜幕 | 暗色玻璃拟态，深靛渐变+流光金+磨砂卡 |
| 变现策略 | 免费跑数据 | 个人主体无支付，阶段1纯免费→阶段2广告→阶段3 B端→阶段4企业主体 |
